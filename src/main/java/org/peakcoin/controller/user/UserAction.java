...
import org.peakcoin.conversations.ConversationUser;
...
public class UserAction {
	...
	public void onRowSelect(SelectEvent event) throws IOException {
        ...
        FacesContext.getCurrentInstance().getExternalContext().redirect("/peakcoin/view/persons/person_card.xhtml?cid="+conversation.getId());
