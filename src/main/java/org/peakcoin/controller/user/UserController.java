...
import org.peakcoin.util.web.FacesScopeQualifier;
import org.peakcoin.util.web.LoginUtil;
import org.peakcoin.util.web.Messages;
import org.peakcoin.util.web.ScopeQualifier;
...
public class UserController {
    ...
    public String login() throws Exception{
		...
		String address = loginUtil.userHasRole(user, "ck") ? "/peakcoin/view/main.xhtml" : "/peakcoin/view/main.xhtml";
