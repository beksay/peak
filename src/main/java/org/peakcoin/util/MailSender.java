...
public class MailSender {
	...
	public boolean send(org.peakcoin.beans.Message m) {
		...
		try {
			...
			message.setSender(new InternetAddress("peakcoin@yandex.ru"));
	...
	public void asyncSend(final org.peakcoin.beans.Message m) {
